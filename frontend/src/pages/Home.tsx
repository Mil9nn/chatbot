...
const Home = () => {
  const { isSending, fetchAllMessages, sendMessage, messages, isLoading, inputMessage, setInputMessage } = useMessageStore();
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-70px)]">
      ...
      <div className="h-full overflow-hidden">
        {isLoading ? (<MessageSkeleton />) : (<ScrollArea className="h-[calc(100%-85px)]">
