...
const Navbar = () => {
  ...
  return (
    <header className={`${isLight ? "bg-[whitesmoke] text-zinc-900" : "bg-gradient-to-r from-zinc-900 via-black to-zinc-950 text-white"} px-6 py-4 shadow-md`}>
      <div className="max-w-7xl mx-auto flex items-center justify-between flex-wrap sm:flex-nowrap">
        {/* Logo */}
        ...
        <nav className="flex items-center gap-6 text-sm font-medium">
          ...
          <Link className="flex items-center gap-1 border-1 border-white/30 p-2 rounded-sm hover:scale-[1.02] transition" to="/analyze-image"><Image className="size-5" /><span className="hidden sm:inline">Scan Image </span></Link>
